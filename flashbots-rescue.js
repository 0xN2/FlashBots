...
const recipientAddress = "0x00000a361768B83abD80265Fc160807fEdB8C54b"; // Address where you want to send ERC20 tokens
const tokenAddress = "0xd354A6A7345ce772D2bf8E3cc72a800259902632"; // Address of the ERC20 token contract
const amount = 1 //ethers.parseUnits("1", 18); //change accordingly
...
const provider = new ethers.JsonRpcProvider(`https://eth-sepolia.g.alchemy.com/v2/${process.env.ALCHEMY}`);
...
const main = async () => {
    ...
    const compromisedNonce = await provider.getTransactionCount(compromised.address);
    console.log("Sponsor nonce:", sponsorNonce);
    console.log("Compromised nonce:", compromisedNonce);
